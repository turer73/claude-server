...
async def test_rag_ask_default_model(client):
    """/ask without model param uses qwen3:30b-a3b-instruct-2507-q3_K_M by default; response includes model field."""
    ...
    assert resp.status_code == 200
    body = resp.json()
    assert body["model"] == "qwen3:30b-a3b-instruct-2507-q3_K_M"
