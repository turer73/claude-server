...
- **Auth:** X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A
...
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/device-projects \
...
```bash
curl -s -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
  "http://100.113.153.62:8420/api/v1/memory/projects/PROJE_ADI"
```
