...
- **Auth Header:** `X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A`
...
```bash
curl -s -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" http://100.113.153.62:8420/api/v1/memory/dashboard
curl -s -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" "http://100.113.153.62:8420/api/v1/memory/notes?device=windows-masaustu&unread_only=true"
```

2. **Oturum sonunda** yaptığın işlerin özetini kaydet:
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/sessions \
  -H "Content-Type: application/json" \
  -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
...
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/discoveries \
  -H "Content-Type: application/json" \
  -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
...
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/tasks \
  -H "Content-Type: application/json" \
  -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
...
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/notes \
  -H "Content-Type: application/json" \
  -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
...
```bash
curl -s -X POST http://100.113.153.62:8420/api/v1/memory/memories \
  -H "Content-Type: application/json" \
  -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" \
...
7. **Arama** yapmak için:
```bash
curl -s -H "X-Memory-Key: fTczkso1377pSg_f7XxfFfn_R7AXkL-QTzkTihMRg2A" "http://100.113.153.62:8420/api/v1/memory/search?q=ANAHTAR_KELIME"
```
