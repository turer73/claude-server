...
- Name: petvet/02-auth-flow.spec.ts >> PetVet — Auth & Dashboard >> dashboard has navigation
- Location: tests/petvet/02-auth-flow.spec.ts:44:7
...
```ts
  ...
  2  | 
  3  | const PHONE = process.env.PETVET_PHONE || "REDACTED_PHONE";
