...
@router.get("/read", response_model=FileReadResponse, dependencies=[Depends(rate_limit_read)])
...
@router.put("/write", dependencies=[Depends(rate_limit_write)])
...
@router.patch("/edit", dependencies=[Depends(rate_limit_write)])
...
@router.delete("/delete", dependencies=[Depends(rate_limit_write)])
